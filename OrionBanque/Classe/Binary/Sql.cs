        ...
        public static void InitialiseBD(string path)
        {
            ...
            if (!System.IO.File.Exists(Classe.KEY.BINARY_PATH_COMPLETE))
            {
                try
                {
                    ...
                    ob.Categories.Add(c1); ob.Categories.Add(c2); ob.Categories.Add(c3); ob.Categories.Add(c4); ob.Categories.Add(c5);
                    ob.Categories.Add(c6); ob.Categories.Add(c7); ob.Categories.Add(c8); ob.Categories.Add(c9); ob.Categories.Add(c10);
                    ob.Categories.Add(c11); ob.Categories.Add(c12); ob.Categories.Add(c13); ob.Categories.Add(c14); ob.Categories.Add(c15);
                    ob.Categories.Add(c16); ob.Categories.Add(c17); ob.Categories.Add(c18); ob.Categories.Add(c19); ob.Categories.Add(c20);
                    ob.Categories.Add(c21); ob.Categories.Add(c22); ob.Categories.Add(c23); ob.Categories.Add(c24); ob.Categories.Add(c25);
                    ob.Categories.Add(c26); ob.Categories.Add(c27); ob.Categories.Add(c28); ob.Categories.Add(c29); ob.Categories.Add(c30);
